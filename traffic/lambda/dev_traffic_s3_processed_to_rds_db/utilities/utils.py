...
class Utils(object):
    ...
    @staticmethod
    def s3_to_df(bucket, filename):
        '''
        :Function that takes the name of an S3 file and returns it as a Pandas dataframe. The filepath is constructed from the bucket and the filename.

        :param bucket: S3 bucket to retrieve the file from
        :type bucket: str
        :param filename: Name of the file
        :type  filename str
        :return: df: dataframe with all the contents of the file
        :rtype: dataframe
        '''
